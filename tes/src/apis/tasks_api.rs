...
pub async fn create_task(configuration: &configuration::Configuration, body: Option<crate::models::CreateTaskRequest>) -> Result<crate::models::Task, Error<CreateTaskError>> {
...
pub async fn get_task(configuration: &configuration::Configuration, task_id: &str) -> Result<crate::models::TaskSummary, Error<GetTaskError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/tasks/{taskId}", local_var_configuration.base_path, taskId=crate::apis::urlencode(task_id));
...
pub async fn list_tasks(configuration: &configuration::Configuration, names: Option<&str>, acls: Option<&str>, page_size: Option<i32>, sort: Option<&str>, page_token: Option<&str>) -> Result<crate::models::TaskSummaryPagedItems, Error<ListTasksError>> {
    let local_var_configuration = configuration;
...
pub async fn update_task(configuration: &configuration::Configuration, task_id: &str, body: Option<crate::models::UpdateTaskRequest>) -> Result<crate::models::Task, Error<UpdateTaskError>> {
    let local_var_configuration = configuration;
