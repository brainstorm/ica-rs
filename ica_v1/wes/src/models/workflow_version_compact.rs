...
/// WorkflowVersionCompact : Compact details of a Workflow version definition

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct WorkflowVersionCompact {
    /// Unique resource ID
...
impl WorkflowVersionCompact {
    /// Compact details of a Workflow version definition
    pub fn new() -> WorkflowVersionCompact {
