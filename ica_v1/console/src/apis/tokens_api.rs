...
pub async fn create_token(
    ...
    cwid: Option<&str>,
    cid: Option<&str>,
    return_session_token: Option<bool>,
) -> Result<crate::models::TokenResponse, Error<CreateTokenError>> {
    ...
    if let Some(ref local_var_str) = client_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("clientId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = api_key {
        local_var_req_builder =
            local_var_req_builder.query(&[("api_key", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = data {
        local_var_req_builder =
            local_var_req_builder.query(&[("data", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = cwid {
        local_var_req_builder =
            local_var_req_builder.query(&[("cwid", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = return_session_token {
        local_var_req_builder =
            local_var_req_builder.query(&[("returnSessionToken", &local_var_str.to_string())]);
    }
    ...
    if let Some(local_var_param_value) = x_api_key {
        local_var_req_builder =
            local_var_req_builder.header("X-API-Key", local_var_param_value.to_string());
    }
...
pub async fn get_token_details(
    configuration: &configuration::Configuration,
) -> Result<crate::models::TokenDetailResponse, Error<GetTokenDetailsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTokenDetailsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn refresh_token(
    configuration: &configuration::Configuration,
    body: Option<crate::models::AccessTokenRequest>,
) -> Result<crate::models::TokenResponse, Error<RefreshTokenError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_token(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
