...
pub async fn create_volume(configuration: &configuration::Configuration, body: crate::models::CreateVolumeRequest, include: Option<&str>) -> Result<crate::models::CreateVolumeResponse, Error<CreateVolumeError>> {
...
pub async fn delete_volume(configuration: &configuration::Configuration, volume_id: &str, purge_object_store_data: Option<bool>) -> Result<crate::models::VolumeResponse, Error<DeleteVolumeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/volumes/{volumeId}", local_var_configuration.base_path, volumeId=crate::apis::urlencode(volume_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = purge_object_store_data {
        local_var_req_builder = local_var_req_builder.query(&[("purgeObjectStoreData", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn get_volume(configuration: &configuration::Configuration, volume_id: &str, tenant_id: Option<&str>, metadata_include: Option<&str>, metadata_exclude: Option<&str>) -> Result<crate::models::VolumeResponse, Error<GetVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn list_volumes(configuration: &configuration::Configuration, page_size: Option<i32>, page_token: Option<&str>, include: Option<&str>, tenant_id: Option<&str>, volume_configuration_name: Option<&str>) -> Result<crate::models::VolumeListResponse, Error<ListVolumesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = volume_configuration_name {
        local_var_req_builder = local_var_req_builder.query(&[("volumeConfigurationName", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn update_volume(configuration: &configuration::Configuration, volume_id: &str, include: Option<&str>, body: Option<crate::models::UpdateVolumeRequest>) -> Result<crate::models::VolumeResponse, Error<UpdateVolumeError>> {
    let local_var_configuration = configuration;
