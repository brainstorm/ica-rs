...
pub async fn create_workflow(configuration: &configuration::Configuration, body: Option<crate::models::CreateWorkflowRequest>) -> Result<crate::models::Workflow, Error<CreateWorkflowError>> {
...
pub async fn get_workflow(configuration: &configuration::Configuration, workflow_id: &str) -> Result<crate::models::Workflow, Error<GetWorkflowError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/workflows/{workflowId}", local_var_configuration.base_path, workflowId=crate::apis::urlencode(workflow_id));
...
pub async fn list_workflows(configuration: &configuration::Configuration, tenant_id: Option<&str>, name: Option<&str>, categories: Option<Vec<String>>, include: Option<Vec<String>>, page_size: Option<i32>, page_token: Option<&str>, sort: Option<&str>) -> Result<crate::models::WorkflowList, Error<ListWorkflowsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow(configuration: &configuration::Configuration, workflow_id: &str, body: Option<crate::models::UpdateWorkflowRequest>) -> Result<crate::models::Workflow, Error<UpdateWorkflowError>> {
    let local_var_configuration = configuration;
