...
pub struct WorkflowRunHistoryEventList {
    /// Items in paged list
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::WorkflowRunHistoryEvent>>,
...
impl WorkflowRunHistoryEventList {
    pub fn new() -> WorkflowRunHistoryEventList {
