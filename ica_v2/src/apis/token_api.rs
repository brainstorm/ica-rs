...
pub async fn create_jwt_token(
    ...
    tenant: Option<&str>,
) -> Result<crate::models::Token, Error<CreateJwtTokenError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateJwtTokenError> =
...
pub async fn refresh_jwt_token(
    configuration: &configuration::Configuration,
) -> Result<crate::models::Token, Error<RefreshJwtTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RefreshJwtTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
