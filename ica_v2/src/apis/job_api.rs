...
pub async fn get_job(configuration: &configuration::Configuration, job_id: &str) -> Result<crate::models::Job, Error<GetJobError>> {
    ...
    let local_var_uri_str = format!("{}/api/jobs/{jobId}", local_var_configuration.base_path, jobId=crate::apis::urlencode(job_id));
...
pub async fn get_jobs(configuration: &configuration::Configuration, status: Option<Vec<String>>, page_offset: Option<&str>, page_token: Option<&str>, page_size: Option<&str>, sort: Option<&str>) -> Result<crate::models::JobPagedList, Error<GetJobsError>> {
    let local_var_configuration = configuration;
