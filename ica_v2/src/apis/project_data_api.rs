...
pub async fn add_secondary_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    secondary_data_id: &str,
) -> Result<(), Error<AddSecondaryDataError>> {
    ...
    let local_var_uri_str = format!(
        ...
        secondaryDataId = crate::apis::urlencode(secondary_data_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddSecondaryDataError> =
...
pub async fn archive_data(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ArchiveDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn complete_folder_upload_session(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    folder_upload_session_id: &str,
    complete_folder_upload_session: Option<crate::models::CompleteFolderUploadSession>,
) -> Result<crate::models::FolderUploadSession, Error<CompleteFolderUploadSessionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CompleteFolderUploadSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_data_in_project(
    configuration: &configuration::Configuration,
    project_id: &str,
    create_data: Option<crate::models::CreateData>,
) -> Result<crate::models::ProjectData, Error<CreateDataInProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDataInProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_download_url_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::Download, Error<CreateDownloadUrlForDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDownloadUrlForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_download_urls_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_url_id_list: Option<crate::models::DataUrlIdList>,
) -> Result<crate::models::DataUrlList, Error<CreateDownloadUrlsForDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDownloadUrlsForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_folder_upload_session(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    create_temporary_credentials: Option<crate::models::CreateTemporaryCredentials>,
) -> Result<crate::models::FolderUploadSession, Error<CreateFolderUploadSessionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFolderUploadSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_inline_view_url_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::InlineView, Error<CreateInlineViewUrlForDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateInlineViewUrlForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_temporary_credentials_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    create_temporary_credentials: Option<crate::models::CreateTemporaryCredentials>,
) -> Result<crate::models::TempCredentials, Error<CreateTemporaryCredentialsForDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateTemporaryCredentialsForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_upload_url_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    file_type: Option<&str>,
    hash: Option<&str>,
) -> Result<crate::models::Upload, Error<CreateUploadUrlForDataError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = file_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("fileType", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = hash {
        local_var_req_builder =
            local_var_req_builder.query(&[("hash", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUploadUrlForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_data(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_eligible_for_linking(
    configuration: &configuration::Configuration,
    project_id: &str,
    ...
    not_linked_to_sample: Option<bool>,
    instrument_run_id: Option<Vec<String>>,
    page_offset: Option<&str>,
    page_token: Option<&str>,
    page_size: Option<&str>,
    sort: Option<&str>,
) -> Result<crate::models::DataPagedList, Error<GetDataEligibleForLinkingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataEligibleForLinkingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_folder_upload_session(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    folder_upload_session_id: &str,
) -> Result<crate::models::FolderUploadSession, Error<GetFolderUploadSessionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        projectId = crate::apis::urlencode(project_id),
        dataId = crate::apis::urlencode(data_id),
        folderUploadSessionId = crate::apis::urlencode(folder_upload_session_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFolderUploadSessionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_non_sample_project_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    page_offset: Option<&str>,
    page_token: Option<&str>,
    page_size: Option<&str>,
) -> Result<crate::models::ProjectDataPagedList, Error<GetNonSampleProjectDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNonSampleProjectDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_data(
    ...
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::ProjectData, Error<GetProjectDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_data_children(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    page_offset: Option<&str>,
    page_token: Option<&str>,
    page_size: Option<&str>,
) -> Result<crate::models::ProjectDataPagedList, Error<GetProjectDataChildrenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectDataChildrenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_data_list(
    configuration: &configuration::Configuration,
    project_id: &str,
    full_text: Option<&str>,
    id: Option<Vec<String>>,
    ...
    page_size: Option<&str>,
    sort: Option<&str>,
) -> Result<crate::models::ProjectDataPagedList, Error<GetProjectDataListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectDataListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_projects_linked_to_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::ProjectList, Error<GetProjectsLinkedToDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectsLinkedToDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_secondary_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::DataList, Error<GetSecondaryDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSecondaryDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn link_data_to_project(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<crate::models::ProjectData, Error<LinkDataToProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LinkDataToProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_secondary_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    secondary_data_id: &str,
) -> Result<(), Error<RemoveSecondaryDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveSecondaryDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn schedule_download_for_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
    schedule_download: crate::models::ScheduleDownload,
) -> Result<crate::models::DataTransfer, Error<ScheduleDownloadForDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ScheduleDownloadForDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unarchive_data(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<(), Error<UnarchiveDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnarchiveDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unlink_data_from_project(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_id: &str,
) -> Result<(), Error<UnlinkDataFromProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkDataFromProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_project_data(
    ...
    project_id: &str,
    data_id: &str,
    project_data: Option<crate::models::ProjectData>,
) -> Result<crate::models::ProjectData, Error<UpdateProjectDataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateProjectDataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
