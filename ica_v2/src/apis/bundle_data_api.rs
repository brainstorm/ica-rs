...
pub async fn get_bundle_data(configuration: &configuration::Configuration, bundle_id: &str, full_text: Option<&str>, id: Option<&str>, filename: Option<&str>, filename_match_mode: Option<&str>, file_path: Option<&str>, file_path_match_mode: Option<&str>, status: Option<&str>, format_id: Option<&str>, format_code: Option<&str>, r#type: Option<&str>, parent_folder_id: Option<&str>, parent_folder_path: Option<&str>, creation_date_after: Option<&str>, creation_date_before: Option<&str>, status_date_after: Option<&str>, status_date_before: Option<&str>, user_tag: Option<&str>, user_tag_match_mode: Option<&str>, run_input_tag: Option<&str>, run_input_tag_match_mode: Option<&str>, run_output_tag: Option<&str>, run_output_tag_match_mode: Option<&str>, connector_tag: Option<&str>, connector_tag_match_mode: Option<&str>, technical_tag: Option<&str>, technical_tag_match_mode: Option<&str>, not_in_run: Option<&str>, not_linked_to_sample: Option<&str>, instrument_run_id: Option<Vec<String>>, page_offset: Option<&str>, page_token: Option<&str>, page_size: Option<&str>, sort: Option<&str>) -> Result<crate::models::BundleDataPagedList, Error<GetBundleDataError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/bundles/{bundleId}/data", local_var_configuration.base_path, bundleId=crate::apis::urlencode(bundle_id));
    ...
    if let Some(ref local_var_str) = format_code {
        local_var_req_builder = local_var_req_builder.query(&[("formatCode", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = r#type {
        local_var_req_builder = local_var_req_builder.query(&[("type", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = parent_folder_id {
        local_var_req_builder = local_var_req_builder.query(&[("parentFolderId", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = run_input_tag {
        local_var_req_builder = local_var_req_builder.query(&[("runInputTag", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = run_output_tag {
        local_var_req_builder = local_var_req_builder.query(&[("runOutputTag", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = connector_tag {
        local_var_req_builder = local_var_req_builder.query(&[("connectorTag", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBundleDataError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn link_data_to_bundle(configuration: &configuration::Configuration, bundle_id: &str, data_id: &str) -> Result<(), Error<LinkDataToBundleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/bundles/{bundleId}/data/{dataId}", local_var_configuration.base_path, bundleId=crate::apis::urlencode(bundle_id), dataId=crate::apis::urlencode(data_id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LinkDataToBundleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn unlink_data_from_bundle(configuration: &configuration::Configuration, bundle_id: &str, data_id: &str) -> Result<(), Error<UnlinkDataFromBundleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkDataFromBundleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
