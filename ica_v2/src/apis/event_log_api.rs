...
pub async fn get_event_logs(configuration: &configuration::Configuration, code: Option<&str>, code_filter_type: Option<&str>, category: Option<&str>, date_from: Option<&str>, date_until: Option<&str>, rows: Option<i32>) -> Result<crate::models::EventLogList, Error<GetEventLogsError>> {
    ...
    if let Some(ref local_var_str) = code_filter_type {
        local_var_req_builder = local_var_req_builder.query(&[("codeFilterType", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = date_until {
        local_var_req_builder = local_var_req_builder.query(&[("dateUntil", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEventLogsError> = serde_json::from_str(&local_var_content).ok();
