...
pub async fn abort_data_transfer(
    configuration: &configuration::Configuration,
    project_id: &str,
    data_transfer_id: &str,
) -> Result<(), Error<AbortDataTransferError>> {
    ...
    let local_var_uri_str = format!(
        ...
        dataTransferId = crate::apis::urlencode(data_transfer_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AbortDataTransferError> =
...
pub async fn get_data_transfer(
    ...
    project_id: &str,
    data_transfer_id: &str,
) -> Result<crate::models::DataTransfer, Error<GetDataTransferError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataTransferError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_transfers(
    ...
    sort: Option<&str>,
) -> Result<crate::models::DataTransferPagedList, Error<GetDataTransfersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = connector {
        local_var_req_builder =
            local_var_req_builder.query(&[("connector", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataTransfersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
