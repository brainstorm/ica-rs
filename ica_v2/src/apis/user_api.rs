...
pub async fn approve_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApproveUserError> =
...
pub async fn assign_tenant_admin_rights_to_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<(), Error<AssignTenantAdminRightsToUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssignTenantAdminRightsToUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users(
...
) -> Result<crate::models::UserList, Error<GetUsersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = email_address {
        local_var_req_builder =
            local_var_req_builder.query(&[("emailAddress", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn revoke_tenant_admin_rights_to_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<(), Error<RevokeTenantAdminRightsToUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeTenantAdminRightsToUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
