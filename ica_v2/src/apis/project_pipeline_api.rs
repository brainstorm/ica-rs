...
pub async fn create_cwl_pipeline(
    ...
    code: &str,
    description: &str,
    workflow_cwl_file: std::path::PathBuf,
    parameters_xml_file: std::path::PathBuf,
    analysis_storage_id: &str,
    tool_cwl_files: Option<Vec<std::path::PathBuf>>,
    metadata_model_file: Option<std::path::PathBuf>,
...
pub async fn create_nextflow_pipeline(
    ...
    code: &str,
    description: &str,
    main_nextflow_file: std::path::PathBuf,
    parameters_xml_file: std::path::PathBuf,
    analysis_storage_id: &str,
    pipeline_language_version_id: Option<&str>,
    nextflow_config_file: Option<std::path::PathBuf>,
    other_nextflow_files: Option<Vec<std::path::PathBuf>>,
    metadata_model_file: Option<std::path::PathBuf>,
    links: Option<crate::models::Links>,
    version_comment: Option<&str>,
    categories: Option<Vec<String>>,
