...
pub async fn create_cwl_pipeline(
    configuration: &configuration::Configuration,
    project_id: &str,
    code: &str,
    description: &str,
    _workflow_cwl_file: std::path::PathBuf,
    _parameters_xml_file: std::path::PathBuf,
    analysis_storage_id: &str,
    _tool_cwl_files: Option<Vec<std::path::PathBuf>>,
    _metadata_model_file: Option<std::path::PathBuf>,
    links: Option<crate::models::Links>,
    version_comment: Option<&str>,
    categories: Option<Vec<String>>,
    html_documentation: Option<&str>,
) -> Result<crate::models::ProjectPipeline, Error<CreateCwlPipelineError>> {
    ...
    if let Some(local_var_param_value) = html_documentation {
        local_var_form =
            local_var_form.text("htmlDocumentation", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateCwlPipelineError> =
...
pub async fn create_nextflow_pipeline(
    configuration: &configuration::Configuration,
    project_id: &str,
    code: &str,
    description: &str,
    _main_nextflow_file: std::path::PathBuf,
    _parameters_xml_file: std::path::PathBuf,
    analysis_storage_id: &str,
    pipeline_language_version_id: Option<&str>,
    _nextflow_config_file: Option<std::path::PathBuf>,
    _other_nextflow_files: Option<Vec<std::path::PathBuf>>,
    _metadata_model_file: Option<std::path::PathBuf>,
    links: Option<crate::models::Links>,
    version_comment: Option<&str>,
    categories: Option<Vec<String>>,
    html_documentation: Option<&str>,
) -> Result<crate::models::ProjectPipeline, Error<CreateNextflowPipelineError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateNextflowPipelineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_pipeline(
    ...
    project_id: &str,
    pipeline_id: &str,
) -> Result<crate::models::ProjectPipeline, Error<GetProjectPipelineError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        projectId = crate::apis::urlencode(project_id),
        pipelineId = crate::apis::urlencode(pipeline_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPipelineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_pipeline_html_documentation(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<crate::models::PipelineHtmlDocumentation, Error<GetProjectPipelineHtmlDocumentationError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPipelineHtmlDocumentationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_pipeline_input_parameters(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<crate::models::InputParameterList, Error<GetProjectPipelineInputParametersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPipelineInputParametersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_pipeline_reference_sets(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<crate::models::ReferenceSetList, Error<GetProjectPipelineReferenceSetsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPipelineReferenceSetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_project_pipelines(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<crate::models::ProjectPipelineList, Error<GetProjectPipelinesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetProjectPipelinesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn link_pipeline_to_project(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<(), Error<LinkPipelineToProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LinkPipelineToProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn release_pipeline(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<(), Error<ReleasePipelineError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReleasePipelineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unlink_pipeline_from_project(
    configuration: &configuration::Configuration,
    project_id: &str,
    pipeline_id: &str,
) -> Result<(), Error<UnlinkPipelineFromProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkPipelineFromProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
