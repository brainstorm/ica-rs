...
pub async fn find_all_matching_activation_codes_for_cwl(
    configuration: &configuration::Configuration,
    search_matching_activation_codes_for_cwl_analysis: Option<
        crate::models::SearchMatchingActivationCodesForCwlAnalysis,
    >,
) -> Result<crate::models::ActivationCodeDetailList, Error<FindAllMatchingActivationCodesForCwlError>>
{
    ...
    local_var_req_builder =
        local_var_req_builder.json(&search_matching_activation_codes_for_cwl_analysis);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindAllMatchingActivationCodesForCwlError> =
...
pub async fn find_all_matching_activation_codes_for_nextflow(
    configuration: &configuration::Configuration,
    search_matching_activation_codes_for_nextflow_analysis: Option<
        crate::models::SearchMatchingActivationCodesForNextflowAnalysis,
    >,
) -> Result<
    crate::models::ActivationCodeDetailList,
    Error<FindAllMatchingActivationCodesForNextflowError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&search_matching_activation_codes_for_nextflow_analysis);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindAllMatchingActivationCodesForNextflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn find_best_matching_activation_code_for_cwl(
    configuration: &configuration::Configuration,
    search_matching_activation_codes_for_cwl_analysis: Option<
        crate::models::SearchMatchingActivationCodesForCwlAnalysis,
    >,
) -> Result<crate::models::ActivationCodeDetail, Error<FindBestMatchingActivationCodeForCwlError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindBestMatchingActivationCodeForCwlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn find_best_matching_activation_codes_for_nextflow(
    configuration: &configuration::Configuration,
    search_matching_activation_codes_for_nextflow_analysis: Option<
        crate::models::SearchMatchingActivationCodesForNextflowAnalysis,
    >,
) -> Result<
    crate::models::ActivationCodeDetail,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FindBestMatchingActivationCodesForNextflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
