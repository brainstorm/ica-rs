...
impl Region {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, code: String, country: Option<crate::models::Country>, city_name: String) -> Region {
        Region {
            id,
            time_created,
            time_modified,
            ...
            tenant_name: None,
            code,
            country: if let Some(x) = country {Some(Box::new(x))} else {None},
            city_name,
        }
    }
}
