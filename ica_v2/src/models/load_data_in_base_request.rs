...
pub struct LoadDataInBaseRequest {
    ...
    #[serde(rename = "allowJaggedRows", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "allowQuotedNewlines", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub allow_quoted_newlines: Option<Option<bool>>,
    /// ID of the data to load into the table
    #[serde(rename = "dataId")]
    pub data_id: String,
    /// field delimiter
    #[serde(rename = "delimiter", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "forceLoad", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub force_load: Option<Option<bool>>,
    /// number of rows to skip (usually for headers)
    #[serde(rename = "headerRowsToSkip", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ignoreUnknownValues", skip_serializing_if = "Option::is_none")]
    pub ignore_unknown_values: Option<bool>,
    /// Include references
    #[serde(rename = "includeReferences", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_references: Option<Option<bool>>,
    /// Include Data Reference
    #[serde(rename = "includeDataReference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_data_reference: Option<Option<bool>>,
    /// Include Sample Reference
    #[serde(rename = "includeSampleReference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_sample_reference: Option<Option<bool>>,
    /// Include Pipeline Reference
    #[serde(rename = "includePipelineReference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_pipeline_reference: Option<Option<bool>>,
    /// Include Pipeline Execution Reference
    #[serde(rename = "includePipelineExecutionReference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_pipeline_execution_reference: Option<Option<bool>>,
    /// Include Tenant Reference
    #[serde(rename = "includeTenantReference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub include_tenant_reference: Option<Option<bool>>,
    /// Specifies a string that represents a null value in a CSV/TSV file.
    #[serde(rename = "nullMarker", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub null_marker: Option<Option<String>>,
    /// The maximum number of bad records that Base can ignore when running the job
    #[serde(rename = "numberOfErrorsAllowed", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "writePreference", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
