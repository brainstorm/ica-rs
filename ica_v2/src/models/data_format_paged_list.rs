...
pub struct DataFormatPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::DataFormat>,
...
impl DataFormatPagedList {
    pub fn new(items: Vec<crate::models::DataFormat>) -> DataFormatPagedList {
        DataFormatPagedList {
            items,
