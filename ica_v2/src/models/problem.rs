...
/// Problem : RFC 7807 Problem object (https://tools.ietf.org/html/rfc7807)
...
impl Problem {
    ...
    pub fn new(r#type: String, title: String, status: i32, parameters: ::std::collections::HashMap<String, String>, timestamp: String) -> Problem {
        Problem {
            id: None,
            r#type,
            title,
