...
impl StorageConfigurationWithDetails {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, r#type: RHashType, status: Status, region: crate::models::Region, is_default: bool, storage_configuration_details: crate::models::StorageConfigurationDetails) -> StorageConfigurationWithDetails {
