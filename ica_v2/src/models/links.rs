...
pub struct Links {
    ...
    pub licenses: Option<Vec<crate::models::Link>>,
    #[serde(rename = "homepages", skip_serializing_if = "Option::is_none")]
    pub homepages: Option<Vec<crate::models::Link>>,
    #[serde(rename = "publications", skip_serializing_if = "Option::is_none")]
    pub publications: Option<Vec<crate::models::Link>>,
}
