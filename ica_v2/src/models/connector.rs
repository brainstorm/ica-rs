...
pub struct Connector {
    ...
    #[serde(rename = "initializationKey", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Connector {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, code: String, active: bool, connected: bool, technical_code: String, mode: Mode, os: Os, installation_status: InstallationStatus, new_connector_version_available: bool) -> Connector {
        Connector {
            id,
            time_created,
            time_modified,
