...
pub struct ProjectDataPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::ProjectData>,
...
impl ProjectDataPagedList {
    pub fn new(items: Vec<crate::models::ProjectData>) -> ProjectDataPagedList {
