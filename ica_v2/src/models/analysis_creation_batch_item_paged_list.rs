...
pub struct AnalysisCreationBatchItemPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::AnalysisCreationBatchItem>,
...
impl AnalysisCreationBatchItemPagedList {
    pub fn new(items: Vec<crate::models::AnalysisCreationBatchItem>) -> AnalysisCreationBatchItemPagedList {
