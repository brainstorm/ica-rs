...
impl DownloadRule {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, code: String, sequence: i32, target_local_folder: String) -> DownloadRule {
        DownloadRule {
            id,
            time_created,
            time_modified,
