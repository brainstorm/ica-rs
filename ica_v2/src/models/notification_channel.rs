...
impl NotificationChannel {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, enabled: bool, r#type: RHashType, address: String) -> NotificationChannel {
        NotificationChannel {
            id,
            time_created,
            time_modified,
