...
impl StorageCredential {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, r#type: RHashType) -> StorageCredential {
        StorageCredential {
            id,
            time_created,
            time_modified,
