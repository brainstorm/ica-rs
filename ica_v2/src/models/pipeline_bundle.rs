...
impl PipelineBundle {
    pub fn new(id: uuid::Uuid, name: String, max_number_of_allowed_slots: i32, active_pipelines: Vec<crate::models::Pipeline>, canceled_pipelines: Vec<crate::models::Pipeline>, retired_pipelines: Vec<crate::models::Pipeline>, regions: Vec<crate::models::Region>, analysis_storages: Vec<crate::models::AnalysisStorage>) -> PipelineBundle {
        PipelineBundle {
            id,
            name,
