...
pub struct Job {
    ...
    #[serde(rename = "timeStarted", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub time_started: Option<Option<String>>,
    #[serde(rename = "timeFinished", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Job {
    pub fn new(id: uuid::Uuid, status: Status, subject_type: String, subject_id: uuid::Uuid, time_created: String, owner: crate::models::User) -> Job {
        Job {
            id,
            status,
