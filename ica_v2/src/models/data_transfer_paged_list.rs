...
pub struct DataTransferPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::DataTransfer>,
...
impl DataTransferPagedList {
    pub fn new(items: Vec<crate::models::DataTransfer>) -> DataTransferPagedList {
