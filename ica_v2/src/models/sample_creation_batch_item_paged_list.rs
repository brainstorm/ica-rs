...
pub struct SampleCreationBatchItemPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::SampleCreationBatchSampleItem>,
...
impl SampleCreationBatchItemPagedList {
    pub fn new(items: Vec<crate::models::SampleCreationBatchSampleItem>) -> SampleCreationBatchItemPagedList {
