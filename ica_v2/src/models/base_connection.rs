...
impl BaseConnection {
    pub fn new(authenticator: String, access_token: String, dns_name: String, user_principal_name: String, database_name: String, schema_name: String, warehouse_name: String, role_name: String) -> BaseConnection {
        BaseConnection {
            authenticator,
            access_token,
            dns_name,
