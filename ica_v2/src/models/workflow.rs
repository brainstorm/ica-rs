...
pub struct Workflow {
    ...
    #[serde(rename = "workflowTags", skip_serializing_if = "Option::is_none")]
    pub workflow_tags: Option<Box<crate::models::PipelineTag>>,
    #[serde(rename = "analysisStorage")]
    pub analysis_storage: Box<crate::models::AnalysisStorage>,
}

impl Workflow {
    pub fn new(id: uuid::Uuid, code: String, urn: String, description: String, analysis_storage: crate::models::AnalysisStorage) -> Workflow {
        Workflow {
            id,
            code,
            urn,
