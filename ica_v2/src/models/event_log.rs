...
pub struct EventLog {
    ...
    pub event_type_category: EventTypeCategory,
    #[serde(rename = "userId")]
    pub user_id: uuid::Uuid,
}

impl EventLog {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, code: String, description: String, event_type_category: EventTypeCategory, user_id: uuid::Uuid) -> EventLog {
        EventLog {
            id,
            time_created,
            time_modified,
