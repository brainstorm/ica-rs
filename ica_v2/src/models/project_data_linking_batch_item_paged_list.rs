...
pub struct ProjectDataLinkingBatchItemPagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::ProjectDataLinkingBatchItem>,
...
impl ProjectDataLinkingBatchItemPagedList {
    pub fn new(items: Vec<crate::models::ProjectDataLinkingBatchItem>) -> ProjectDataLinkingBatchItemPagedList {
