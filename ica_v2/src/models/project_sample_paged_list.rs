...
pub struct ProjectSamplePagedList {
    #[serde(rename = "items")]
    pub items: Vec<crate::models::ProjectSample>,
...
impl ProjectSamplePagedList {
    pub fn new(items: Vec<crate::models::ProjectSample>) -> ProjectSamplePagedList {
