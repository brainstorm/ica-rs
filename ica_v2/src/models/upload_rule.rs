...
impl UploadRule {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, code: String, local_folder: String, file_pattern: String, project: Option<crate::models::Project>) -> UploadRule {
        UploadRule {
            id,
            time_created,
            time_modified,
