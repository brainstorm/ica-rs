...
impl WorkflowSession {
    pub fn new(id: uuid::Uuid, time_created: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, user_reference: String, workflow: crate::models::Workflow, status: Status, tags: crate::models::WorkflowSessionTag) -> WorkflowSession {
        WorkflowSession {
            id,
            time_created,
            owner_id,
