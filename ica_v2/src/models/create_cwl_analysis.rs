...
impl CreateCwlAnalysis {
    pub fn new(user_reference: String, pipeline_id: String, tags: crate::models::AnalysisTag, activation_code_detail_id: uuid::Uuid, analysis_input: crate::models::CwlAnalysisInput) -> CreateCwlAnalysis {
        CreateCwlAnalysis {
            user_reference,
            pipeline_id,
            tags: Box::new(tags),
