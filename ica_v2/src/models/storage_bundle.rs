...
impl StorageBundle {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, bundle_name: String, entitlement_name: String, region: crate::models::Region) -> StorageBundle {
        StorageBundle {
            id,
            time_created,
            time_modified,
