...
pub struct AnalysisCreationBatchItemRequest {
...
impl AnalysisCreationBatchItemRequest {
    pub fn new(user_reference: String, pipeline_id: String, tags: crate::models::AnalysisTag) -> AnalysisCreationBatchItemRequest {
