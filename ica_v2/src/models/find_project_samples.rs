...
impl FindProjectSamples {
    pub fn new(
        conditions: Vec<crate::models::FindSampleCondition>,
        date_conditions: Vec<crate::models::FindSampleDateCondition>,
        number_conditions: Vec<crate::models::FindSampleNumberCondition>,
        boolean_conditions: Vec<crate::models::FindSampleBooleanCondition>,
    ) -> FindProjectSamples {
        FindProjectSamples {
            conditions,
            date_conditions,
