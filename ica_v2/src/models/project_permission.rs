...
pub struct ProjectPermission {
    ...
    pub workgroup: Option<Box<crate::models::Workgroup>>,
    /// Only present when membershipType is EMAIL
    #[serde(rename = "invitationAccepted", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invitation_accepted: Option<Option<bool>>,
    /// Only present when user is invited by EMAIL
    #[serde(rename = "invitationRejected", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invitation_rejected: Option<Option<bool>>,
...
impl ProjectPermission {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, role_project: RoleProject, role_flow: RoleFlow, role_base: RoleBase, role_bench: RoleBench, membership_type: MembershipType, upload_allowed: bool, download_allowed: bool) -> ProjectPermission {
        ProjectPermission {
            id,
            time_created,
            time_modified,
            ...
            email_address: None,
            workgroup: None,
            invitation_accepted: None,
            invitation_rejected: None,
            upload_allowed,
            download_allowed,
        }
    }
