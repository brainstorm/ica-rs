...
impl Bundle {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, region: crate::models::Region, release_version: String, status: Status) -> Bundle {
        Bundle {
            id,
            time_created,
            time_modified,
