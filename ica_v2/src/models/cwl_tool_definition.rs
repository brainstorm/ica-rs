...
pub struct CwlToolDefinition {
    ...
    #[serde(rename = "versionComment", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub release_version: Option<Option<i32>>,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Box<crate::models::Link>>,
...
impl CwlToolDefinition {
    pub fn new(id: uuid::Uuid, time_created: String, time_modified: String, owner_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, status: Status) -> CwlToolDefinition {
        CwlToolDefinition {
            id,
            time_created,
            time_modified,
