...
pub struct CreateNextflowAnalysis {
    ...
    #[serde(rename = "analysisStorageId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub analysis_storage_id: Option<Option<uuid::Uuid>>,
    /// The id of the folder in which the output folder should be created.
    #[serde(rename = "outputParentFolderId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub output_parent_folder_id: Option<Option<String>>,
    #[serde(rename = "analysisOutput", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub analysis_output: Option<Option<Vec<crate::models::AnalysisOutputMapping>>>,
    #[serde(rename = "analysisInput")]
    pub analysis_input: Box<crate::models::NextflowAnalysisInput>,
}

impl CreateNextflowAnalysis {
    pub fn new(user_reference: String, pipeline_id: String, tags: crate::models::AnalysisTag, activation_code_detail_id: uuid::Uuid, analysis_input: crate::models::NextflowAnalysisInput) -> CreateNextflowAnalysis {
