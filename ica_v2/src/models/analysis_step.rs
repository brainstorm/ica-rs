...
pub struct AnalysisStep {
    ...
    #[serde(rename = "queueDate", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl AnalysisStep {
    pub fn new(id: String, name: String, status: Status, technical: bool, logs: crate::models::AnalysisStepLogs) -> AnalysisStep {
        AnalysisStep {
            id,
            name,
            status,
