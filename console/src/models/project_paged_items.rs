...
/// ProjectPagedItems : Paged list response



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ProjectPagedItems {
    /// Items in paged list
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::Project>>,
...
impl ProjectPagedItems {
    /// Paged list response
    pub fn new() -> ProjectPagedItems {
        ProjectPagedItems {
            items: None,
            item_count: None,
